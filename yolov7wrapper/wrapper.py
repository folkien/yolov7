...
def ModelLoad(directoryPath: str = './ObjectDetectors/yolov7coco/',
              modelFilename : str = 'yolov7.pt',
              gpuID: int = 0,
              imgsz: int = 640,
              trace: bool = False,
              half: bool = True,
    ...
    # Model : Load model
    model = attempt_load(f"{directoryPath}{modelFilename}",
